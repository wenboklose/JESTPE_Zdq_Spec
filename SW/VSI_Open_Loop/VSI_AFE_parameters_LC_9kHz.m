...
FWPI_a1      = 0.08921;         % AFE Phase-Locked Loop pi controller
FWPI_a2      = -0.08901;        % AFE Phase-Locked Loop pi controller
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% AFE parameters
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Vse         = 57.5;
...
La          = 1/50*962e-6;       % inductor No. 1
RLa         = 0.123;        
Lb          = 1/50*985e-6;       % inductor No. 2
RLb         = 0.132;
Lc          = 1/50*972e-6;       % inductor No. 3
RLc         = 0.089;
%% output filter cap parameters
Ca          = 1/2*32e-6;        % cap No. 1
LCa         = 0.61e-6;
RCa         = 0.051;
Cb          = 1/2*31.5e-6;      % cap No. 2
LCb         = 0.61e-6;
RCb         = 0.054;
Cc          = 1/2*31.8e-6;      % cap No. 3
LCc         = 0.63e-6;
RCc         = 0.052;
%% dc link cap parameters
Cdc_vsi     = 147.3e-6;
