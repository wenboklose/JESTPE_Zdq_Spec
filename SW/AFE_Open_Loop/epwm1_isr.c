...
// variables for pll
double DEF_pll =100;							//control loop for PLL (Hz)
...
double counter_PLL_Max			= 500;//200000;
...
void inital_para(void)
{
	...
	Vd_out_AFE		  		= 94;				//reference voltage D value in DQ axis
	Vq_out_AFE		  		= -15.75;				//reference voltage Q value in DQ axis
	Vd_out_AFE_final		= 0;
	Vq_out_AFE_final		= 0;
...
{	
	out_vector_alpha_AFE	= COS_VPN_theta_AFE*Vd_out_AFE-SIN_VPN_theta_AFE*Vq_out_AFE;
	out_vector_beta_AFE		= SIN_VPN_theta_AFE*Vd_out_AFE+COS_VPN_theta_AFE*Vq_out_AFE;
    Ma_1					= out_vector_alpha_AFE*SQRT_3over2/270;//							// Valpha*sqrt(3/2)/Vdc
    Mk_1					= out_vector_beta_AFE*SQRT_1over2/270;//
//     if (Vdc_AFE< vdcref_AFE)
// 	{	
//         Ma_1					= out_vector_alpha_AFE*SQRT_3over2/Vdc_AFE;//							// Valpha*sqrt(3/2)/Vdc
//         Mk_1					= out_vector_beta_AFE*SQRT_1over2/Vdc_AFE;//
// 	}
// 	else 
// 	{
// 		 Ma_1					= out_vector_alpha_AFE*SQRT_3over2/270;//							// Valpha*sqrt(3/2)/Vdc
//          Mk_1					= out_vector_beta_AFE*SQRT_1over2/270;//						// Vbeta*sqrt(3/2)/Vdc/sqrt(3)
// 		
// 	}
