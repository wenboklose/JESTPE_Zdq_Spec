...
double counter_PLL_Max			= 26000;//200000;
...
//             I_loop_AFE();
    ...
    *y8=Vd_out_VSI;//FW_VLL[0];//Dd_out_VSI;//Id_VSI+Per;
    *y9=Vq_out_VSI;
}
...
// 	}
	...
	idref_VSI=K_decoup_VSI_v*Two_PI*f_line*Cout_VSI*Vq_VSI+Kpv_VSI*(err_vd)+In_idref_VSI;		
	iqref_VSI=-K_decoup_VSI_v*Two_PI*f_line*Cout_VSI*Vd_VSI+Kpv_VSI*(err_vq)+In_iqref_VSI;
}
