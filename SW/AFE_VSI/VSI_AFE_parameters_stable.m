...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% case 1:
Kpv_VSI		= 0.0779;       % VSI voltage loop p controller
Kiv_VSI		= 125.6637;     % VSI voltage loop i controller
Kpi_VSI		= 0.0102*270;   % VSI current loop p controller
Kii_VSI		= 18.62*270;    % VSI current loop i controller
Kpv_AFE		= 0.022;        % AFE voltage loop p controller
Kiv_AFE		= 6.9813;       % AFE voltage loop i controller
