...
int AFE_OK                      = 0;
double counter_AFE				= 0;
double counter_AFE_Max			= 3000;//200000;
...
const double bandwidth_v_AFE 	= 240;
...
// calculate PLL PI parameters
	...
	{
		counter_AFE++;
		if (counter_AFE>counter_AFE_Max)	
		{
			AFE_OK=1;
			counter_AFE=0;
		}		
...
void V_loop_VSI(void)
{
	...
	{	
		vdslop_VSI = vdslop_VSI+0.02;
//         vqslop_VSI = vqslop_VSI+0.02;
	}
	else 
	{
		vdslop_VSI = vdref_VSI;
//         vqslop_VSI = vqref_VSI;
	}
