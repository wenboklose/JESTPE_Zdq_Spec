...
for k=1:length(freq_r)
   eig_L(:,k) = eig(Resp_L(:,:,k)*(1*Resp_I(:,:,k)+D));
end
...
index_1=find(Mag_eigs_L(1,:)>0.9999&Mag_eigs_L(1,:)<1.0001);
index_2=find(Mag_eigs_L(2,:)>0.9999&Mag_eigs_L(2,:)<1.0001);
