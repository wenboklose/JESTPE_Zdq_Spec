...
figHandle=figure(1000)
set(figHandle, 'Position', [50, 10, 1000, 800]);
bode(Z_VSI_o_400_fi_4k_fv_250_test,Z_VSI_o_400_fi_4k_fv_150_test,...
    Z_VSI_o_400_fi_4k_fv_100_test,Z_AFE_400_fi_1000_fv_70_pll_1_test)
grid on
Bode_Darklines(3)
...
index_1=find(Mag_eigs_L(1,:)>0.995&Mag_eigs_L(1,:)<1.005);
index_2=find(Mag_eigs_L(2,:)>0.995&Mag_eigs_L(2,:)<1.005);
...
index_1=find(angle_eigs_L(1,:)>-pi-0.1&angle_eigs_L(1,:)<-pi+0.1);
index_2=find(angle_eigs_L(2,:)>-pi-0.1&angle_eigs_L(2,:)<-pi+0.1);
